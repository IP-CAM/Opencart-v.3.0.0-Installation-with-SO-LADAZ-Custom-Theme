...
class Deactivate {
    ...
    public function __construct($data) {
        ...
        $this->app_slug = 'google-maps';
        $this->app_name = 'Google Maps';
    ...
    public function setDeactivateReasons() {
        return require ( (__DIR__) . '/google-maps-assets/reasons.php' );
    }
...
class ControllerExtensionModuleElfsightGoogleMaps extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['module_google_maps_status'])) {
            $data['module_google_maps_status'] = $this->request->post['module_google_maps_status'];
        } else {
            $data['module_google_maps_status'] = $this->config->get('module_google_maps_status');
        }
    ...
    public function setDeactivateReasons() {
        return require ( './controller/extension/module/google-maps-assets/reasons.php' );
    }
    ...
    public function uninstall() {
        ...
        include './controller/extension/module/google-maps-assets/popup.php';
    }
